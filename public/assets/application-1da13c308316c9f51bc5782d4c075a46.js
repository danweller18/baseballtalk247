...
(function() {
  ...
  ready = function() {
    ...
    return $('#manufacturer_manufacturer_id').on('change', function() {
      $('#review_bat_id').remove();
      return $('#review_bat_id_original').clone().attr('id', 'review_bat_id').insertAfter('#review_bat_id_original').show().find(':not(option[data-manufacturer="' + $(this).val() + '"])').remove();
    });
  };
